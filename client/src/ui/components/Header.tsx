    ...
    return (
        <div className="mainHeader flex justify-between w:full mx-64 mt-10">
            <div className="logo">
                ...
                <path d="M18.4997 1.72238C20.3441 0.656684 22.6171 0.656682 24.4615 1.72238L39.704 10.5297C41.5465 11.5943 42.6814 13.5607 42.6814 15.6886V33.3114C42.6814 35.4393 41.5465 37.4057 39.704 38.4703L24.4615 47.2776C22.6171 48.3433 20.3441 48.3433 18.4997 47.2776L3.25712 38.4703C1.41464 37.4057 0.279776 35.4393 0.279776 33.3114V15.6886C0.279776 13.5607 1.41464 11.5943 3.25712 10.5297L18.4997 1.72238Z" fill="#0E1F27"/>
